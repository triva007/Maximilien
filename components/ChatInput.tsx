  ...
  return (
    <form onSubmit={handleSubmit} className="flex items-center p-3">
      <textarea
        ...
        className="flex-1 bg-gray-700/80 text-white placeholder-gray-400 border border-transparent rounded-lg py-3 px-4 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-shadow duration-200 resize-none max-h-36 shadow-sm"
        rows={1}
        disabled={isLoading}
      />
      <button
